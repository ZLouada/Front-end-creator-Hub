    ...
    <div className="min-h-full bg-surface p-5 sm:p-8">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="flex items-center justify-between animate-fade-up">
          ...
          <button
            className="hidden sm:flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-bold text-brand-900 bg-gradient-to-br from-brand-400 to-brand-500 shadow-glow-sm transition-all hover:-translate-y-0.5 hover:shadow-glow active:scale-95"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-surface-card rounded-2xl p-6 shadow-soft border border-brand-300/20 animate-fade-up" style={{ animationDelay: '0.2s' }}>
            <div className="flex items-center justify-between mb-6">
              ...
              <span className="text-xs font-bold px-3 py-1.5 rounded-xl bg-brand-50 text-brand-700 border border-brand-100">
                6 months
              </span>
            </div>
            <div className="h-64">
          ...
          <div className="bg-surface-card rounded-2xl p-6 shadow-soft border border-brand-300/20 animate-fade-up" style={{ animationDelay: '0.26s' }}>
            <div className="flex items-center justify-between mb-6">
              <div>
                <h3 className="text-base font-bold text-gray-900">New Supporters</h3>
        ...
        <div className="bg-surface-card rounded-2xl shadow-soft border border-brand-300/20 overflow-hidden animate-fade-up" style={{ animationDelay: '0.32s' }}>
          <div className="flex items-center justify-between px-6 py-5 border-b border-brand-300/20">
            <h3 className="text-base font-bold text-gray-900">Recent Activity</h3>
            <button className="text-xs font-bold text-brand-600 hover:text-brand-700 transition-colors">View all →</button>
          </div>
          <div className="divide-y divide-gray-50">
            {recentActivity.map((item, i) => (
              <div key={item.id} className="flex items-center justify-between px-6 py-4 hover:bg-brand-50/60 transition-colors">
                <div className="flex items-center gap-4">
                  <div className="w-9 h-9 rounded-full bg-brand-100 flex items-center justify-center text-lg shrink-0">
                    {item.avatar}
                  </div>
                  <div>
