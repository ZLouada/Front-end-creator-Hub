  ...
  return (
    <footer className={styles.footer}>
      <div className={styles.grid}>
        <div>
          <h2 className="text-2xl font-semibold font-serif">CreatorHub</h2>
      ...
      <div className={styles.bottom}>
        ...
        <div className="font-semibold text-sm uppercase flex items-center gap-2">
          Made with <Heart size={16} fill="#1A1A1A" className="dark:fill-white" /> by CreatorHub Team
        </div>
