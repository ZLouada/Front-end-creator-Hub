      ...
      <div className="bg-surface-card rounded-2xl border border-editorial-border shadow-soft overflow-hidden">
        <div className="flex items-center justify-between flex-wrap gap-4 p-6">
          ...
          <div className="flex items-center gap-4">
            <div
              className="w-12 h-12 rounded-lg flex items-center justify-center text-xl font-bold text-white shrink-0 bg-brand-900 shadow-soft-sm"
            >
              C
            </div>
            <div>
            ...
            {status === 'active' ? (
              <>
                ...
                <button
                  ...
                  className="px-3 py-1.5 text-xs font-bold text-danger border border-danger-100 rounded-lg hover:bg-danger-50 transition-all active:scale-95"
                >
                  Cancel
                </button>
              </>
          ...
          <div className="relative z-10 bg-surface-card rounded-2xl shadow-soft-xl w-full max-w-sm p-7 animate-fade-up">
            ...
            <div className="flex gap-3 mt-6">
              ...
              <button
                ...
                disabled={isCancelling}
                className="flex-1 py-2.5 rounded-lg text-sm font-bold text-white bg-danger hover:bg-danger-600 transition-all disabled:opacity-60 flex items-center justify-center gap-2"
              >
                {isCancelling ? (
                  <>
