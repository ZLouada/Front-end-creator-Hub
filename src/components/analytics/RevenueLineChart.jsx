...
export default function RevenueLineChart({ data }) {
	...
	return (
		<div className="bg-surface-card p-6 rounded-2xl shadow-soft border border-brand-300/20">
				...
				{safeData.map((point) => {
					...
					return (
						<div key={point.label} className="flex-1 flex flex-col items-center gap-2">
							<div
								className="w-full rounded-lg bg-gradient-to-t from-brand-200 to-brand-400 shadow-soft-sm"
