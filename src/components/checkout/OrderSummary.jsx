...
export default function OrderSummary({ planName = 'Pro Tier Subscription', product = 'Creative Studio', price = 10.0 }) {
	return (
		<div className="bg-surface w-full p-6 rounded-2xl border border-brand-300/20">
			...
			<div className="border-t border-brand-300/20 pt-4 flex items-center justify-between">
