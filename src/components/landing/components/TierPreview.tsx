      ...
      <div className={styles.container}>
        ...
        <div className={styles.mainGrid}>
          ...
          <div className="flex flex-col items-center">
            <p className="mb-4 font-bold text-sm text-brand-700 dark:text-gray-300 flex items-center gap-2">
              ...
              <div className={styles.phoneScreen}>
                ...
                <div className="flex-grow">
                    ...
                    <div className="animate-in fade-in duration-300">
                        ...
                        <div className="mt-4 p-4 border border-brand-300/20 rounded-xl bg-white dark:bg-[#1A1A1A] dark:border-gray-700 shadow-soft-sm">
                        ...
                        {['JazzCash', 'bKash', 'EasyPaisa'].map((pay) => (
                            <div key={pay} className="flex items-center justify-between p-2 border border-brand-300/20 rounded-lg bg-white dark:bg-[#1A1A1A] dark:border-gray-700">
                    ...
                    <div className="animate-in slide-in-from-bottom-2 duration-300">
                        ...
                        <div className="p-3 border border-brand-300/20 rounded-xl bg-white dark:bg-[#1A1A1A] dark:border-gray-700">
                        ...
                        <div className="p-3 border border-brand-300/20 dark:border-gray-700 rounded-xl bg-gradient-to-br from-brand-400 to-brand-500">
