  ...
  return (
    <section className="py-12 md:py-24 bg-brand-50 dark:bg-[#0A0A0A]">
      <div className="container mx-auto px-4 md:px-6">
        ...
        {/* Dashboard Wrapper */}
        <div className="flex flex-col lg:flex-row max-w-6xl mx-auto border border-brand-300/20 dark:border-gray-700 rounded-3xl overflow-hidden shadow-soft-lg bg-white dark:bg-[#141414]">
          ...
          <div className={styles.sidebar}>
            ...
            <Users size={20} className="text-gray-400 dark:text-gray-500 hover:text-white cursor-pointer transition-colors duration-300" />
            <TrendingUp size={20} className="text-gray-400 dark:text-gray-500 hover:text-white cursor-pointer transition-colors duration-300" />
            <Settings size={20} className="text-gray-400 dark:text-gray-500 hover:text-white cursor-pointer transition-colors duration-300" />
          </div>
          ...
          <div className="flex-1 flex flex-col min-w-0">
            ...
            {/* Top Bar */}
            <div className="border-t lg:border-t-0 lg:border-l border-brand-300/15 dark:border-gray-700 p-4 md:p-6 flex justify-between items-center bg-white dark:bg-[#141414]">
              ...
              <div className="flex gap-2 md:gap-4">
                <div className="p-2 border border-brand-300/20 dark:border-gray-700 rounded-lg hover:bg-brand-50 transition-colors duration-300">
                  <Bell size={18} />
                </div>
            ...
            <div className="p-4 md:p-8 space-y-6 md:space-y-8 border-t lg:border-l border-brand-300/15 dark:border-gray-700 flex-1">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
                <div className={styles.statCard}>
                  <p className="text-[10px] font-semibold text-gray-400 dark:text-gray-500 uppercase mb-1">MRR (Revenue)</p>
                ...
                <div className={styles.statCard}>
                  <p className="text-[10px] font-semibold text-gray-400 dark:text-gray-500 uppercase mb-1">Subscribers</p>
                  <div className="flex items-end justify-between">
                ...
                <div className={styles.statCard}>
                  <p className="text-[10px] font-semibold text-gray-400 dark:text-gray-500 uppercase mb-1">Churn Rate</p>
                  <div className="flex items-end justify-between">
              ...
              {/* Main Growth Chart */}
              <div className="border border-brand-300/15 dark:border-gray-700 rounded-2xl p-4 md:p-6 bg-white dark:bg-[#141414] shadow-soft-sm">
                <div className="flex justify-between items-center mb-6">
                  ...
                  <div className="flex items-center gap-1 md:gap-2">
                    ...
                    <span className="text-[8px] md:text-[10px] font-semibold uppercase text-gray-400 dark:text-gray-500">Last 7 Days</span>
                  </div>
                </div>
                ...
                <div className="flex justify-between mt-3 md:mt-4">
                  {['M', 'T', 'W', 'T', 'F', 'S', 'S'].map((day, i) => (
                    <span key={i} className="text-[10px] font-semibold text-gray-400 dark:text-gray-500">{day}</span>
                  ))}
                </div>
              </div>
