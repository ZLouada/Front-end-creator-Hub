    ...
    <section className="py-12 md:py-24 bg-brand-50">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="text-center mb-10 md:mb-16">
          <h2 className="text-3xl md:text-6xl font-extrabold text-brand-900 leading-tight">
            The Creator <span className="text-gradient-gold">Studio</span>
          </h2>
          <p className="mt-2 md:mt-4 text-base md:text-xl font-semibold text-gray-500">
            Advanced analytics, simplified for your growth.
          </p>
        </div>

        {/* Dashboard Wrapper */}
        <div className="flex flex-col lg:flex-row max-w-6xl mx-auto border border-brand-300/20 rounded-3xl overflow-hidden shadow-soft-lg bg-white">
          ...
          <div className="flex-1 flex flex-col min-w-0">
            ...
            {/* Top Bar */}
            <div className="border-t lg:border-t-0 lg:border-l border-brand-300/15 p-4 md:p-6 flex justify-between items-center bg-white">
              <span className="font-bold tracking-tight text-sm md:text-base text-brand-900">Studio / Analytics</span>
              <div className="flex gap-2 md:gap-4">
                <div className="p-2 border border-brand-300/20 rounded-lg hover:bg-brand-50 transition-colors duration-300">
                  <Bell size={18} />
                </div>
            ...
            {/* Content Body */}
            <div className="p-4 md:p-8 space-y-6 md:space-y-8 border-t lg:border-l border-brand-300/15 flex-1">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
                <div className={styles.statCard}>
                  ...
                  <div className="flex items-end justify-between">
                    <h3 className="text-xl md:text-2xl font-bold text-brand-900">PKR 142k</h3>
                ...
                <div className={styles.statCard}>
                  ...
                  <div className="flex items-end justify-between">
                    <h3 className="text-xl md:text-2xl font-bold text-brand-900">2,840</h3>
              ...
              {/* Main Growth Chart */}
              <div className="border border-brand-300/15 rounded-2xl p-4 md:p-6 bg-white shadow-soft-sm">
                <div className="flex justify-between items-center mb-6">
                  <h4 className="font-bold text-sm md:text-lg tracking-tight text-brand-900">Subscriber Growth</h4>
                ...
                <div className="h-40 md:h-64 flex items-end justify-between gap-1 md:gap-4 border-b border-brand-300/15 pb-1">
